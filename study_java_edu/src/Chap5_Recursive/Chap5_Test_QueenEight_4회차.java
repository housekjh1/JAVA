...
//                    row = p.getX();
//                    col = p.getY();
//                    d[row][col] = 0; // 이전에 놓았던 퀸 제거
//                    count--;
//                    col++; // 다음 열로 이동
//                } else {
////                    // 스택이 비어있으면 더 이상 백트래킹할 수 없으므로 종료
//                    break;
//                }
//            }
//        }
...
//
//		for (int x = cx, y = cy; x < d.length && y >= 0; x++, y--)
//			if (d[x][y] == 1)
//				return false;
//		for (int x = cx, y = cy; x >= 0 && y < d[0].length; x--, y++)
//			if (d[x][y] == 1)
//				return false;
//		return true;
//	}
...
//			if (d[x][y] == 1)
//				return false;
//		for (int x = cx, y = cy; x < d.length && y < d[0].length; x++, y++)
//			if (d[x][y] == 1)
//				return false;
//		return true;
//	}
...
//		int x = row;
//		if (x < d.length) {
//			for (int c = col; c < d[0].length; c++) {
//				if (CheckMove(d, x, c) && d[x][c] == 0) {
//					Point p = new Point(x, c);
//					return p;
//				}
//			}
//		}
//		return null; // 현재 행에 퀸을 배치할 수 없는 경우
//	}
//
